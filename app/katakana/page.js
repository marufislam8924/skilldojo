  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.header}>
        ...
        <p className={styles.headerDesc}>21 lessons · Master all 46 katakana characters with AI voice</p>
      </div>
      <div className={styles.grid}>
        {katakanaLessons.map((lesson) => (
          <div key={lesson.id} className={styles.lessonCard} onClick={() => router.push(`/katakana/${lesson.id}`)}>
